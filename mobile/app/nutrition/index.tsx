...
export default function NutritionListScreen() {
    ...
    const getBadgeStyle = (level: string) => {
        ...
        return {
            bg: isDark ? badge.bgDark : badge.bg,
                    ...
                    return (
                        ...
                        >
                            ...
                            <View style={[styles.avatar, { backgroundColor: isDark ? '#4E260040' : '#FFF3E0' }]}>
                                <Ionicons name="paw" size={24} color="#E67E22" />
                            </View>
...
const styles = StyleSheet.create({
    ...
    cardContent: { flex: 1, marginLeft: spacing.md, marginRight: spacing.sm },
    nameRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
    activityBadge: { fontSize: fontSize.xs, fontWeight: '800', textTransform: 'uppercase' },
    rationName: { fontSize: fontSize.lg, fontWeight: 'bold', flex: 1 },
    cardSub: { fontSize: fontSize.sm, marginTop: 4 },
